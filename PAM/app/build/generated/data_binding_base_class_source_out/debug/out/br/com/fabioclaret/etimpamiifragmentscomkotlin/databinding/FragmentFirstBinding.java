...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView4,
      @NonNull ImageView imageView6, @NonNull TextView textView) {
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, imageView4, imageView6,
          textView);
    }
